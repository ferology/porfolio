          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                <Button 
                  onClick={() => handleButtonAction(content.hero.buttons.primary)}
                  size="lg"
                  className="group"
                >
                ...
                <Button 
                  variant="outline" 
                  size="lg"
                  onClick={() => handleButtonAction(content.hero.buttons.secondary)}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className="text-2xl font-semibold mb-4">{content.about.journey.title}</h3>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className="text-2xl font-semibold mb-4">{content.about.skills.title}</h3>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button 
                size="lg" 
                className="group"
                onClick={() => handleButtonAction(content.contact.buttons.primary)}
              >
              ...
              <Button 
                variant="outline" 
                size="lg"
                onClick={() => handleButtonAction(content.contact.buttons.secondary)}
              >
